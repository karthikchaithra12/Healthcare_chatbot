...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam=Label(self, text="Made by:", bg="yellow", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="B PAVAN", bg="lightgreen", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="KARTHIK M C", bg="lightgreen", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="ROHIT M SANK", bg="lightgreen", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="BINDUSHREE Y V", bg="lightgreen", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam4.pack()
